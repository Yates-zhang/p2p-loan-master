package com.vanguard.p2p.support.upload;

import com.alibaba.fastjson.JSONObject;
import com.vanguard.p2p.utils.DateUtils;
import com.vanguard.p2p.utils.ImageUtils;
...
public class UploadManager {
	...
	public static String rename(MultipartFile file) {
		...
		// 新文件名称，不设置时默认为原文件名
		return System.currentTimeMillis() + (new Random().nextInt(9999 - 1000 + 1) + 1000)
